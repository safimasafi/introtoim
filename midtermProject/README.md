...
My first sketch consisted of functions that defined the circles, their movement, and if the game was over or not [code provided in the journal](#https://github.com/safimasafi/introtoim/blob/main/midtermProject/journal.md)
